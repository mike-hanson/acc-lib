...
public class CarInfo
{
  ...
  {
      return !this.Drivers.Any()? $"Race Number: {this.RaceNumber}, Team: {this.TeamName}": $"Race Number: {this.RaceNumber}, Driver: {this.Drivers[this.CurrentDriverIndex].InitialAndLastName}, Car: {this.CarModelType}";
  }
